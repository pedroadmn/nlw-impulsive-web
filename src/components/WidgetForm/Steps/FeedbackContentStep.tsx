        ...
        <>
            ...
            <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
                <textarea
                    ...
                    placeholder="Tell us details about what is happening..."
                ...
                <footer className="flex gap-2 mt-2">
                    ...
                    <button
                        ...
                        className="p-2 bg-brand-500 rounded-md border-transparent flex-1 flex justify-center items-center text-sm
                                   ...
                                   focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500"> Enviar feedback
